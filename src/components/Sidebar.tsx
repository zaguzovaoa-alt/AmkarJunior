...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    switch (currentRole) {
      case "parent":
        return [
          ...
          { id: "parent_homeworks", label: "Домашнее задание", icon: FileText },
          { id: "parent_attendance", label: "Посещения", icon: CheckSquare },
          { id: "parent_payments", label: "Платежи", icon: DollarSign },
          { id: "parent_store", label: "Экипировка", icon: ShoppingCart },
          {
            id: "parent_messages",
            label: "Сообщения",
            icon: MessageSquare,
      ...
      case "trainer":
        return [
          ...
          { id: "trainer_homeworks", label: "Домашнее задание", icon: FileText },
          {
            id: "trainer_messages",
            label: "Сообщения",
            icon: MessageSquare,
  ...
  return (
    <div
      id="crm-sidebar"
      className="w-64 bg-white border-r border-gray-100 flex flex-col h-full text-slate-800 min-h-[700px]"
    >
      {/* Brand Header */}
      <div className="pt-8 pb-6 flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="flex flex-col">
          <div className="font-extrabold tracking-[-0.02em] text-slate-900 text-[15px] leading-none uppercase">
            АМКАР ЮНИОР
          </div>
          ...
          return (
            ...
            >
              <div className="flex items-center space-x-3">
                <Icon
                  className={`w-4 h-4 ${isActive ? "text-slate-900" : "text-gray-400 group-hover:text-slate-600"}`}
                />
