...
export const AmkarLogo: React.FC<AmkarLogoProps> = ({ className = '', width = "100%", height = "100%" }) => {
  return (
    <svg 
      ...
      fill="none"
    >
      <g stroke="#E31E24" strokeWidth="12" strokeLinecap="square" strokeLinejoin="miter">
        {/* Left Side */}
      ...
      {/* Bottom Pentagon */}
      <polygon 
        points="75,238 85,248 81,259 69,259 65,248" 
        fill="#E31E24" 
      />
    </svg>
  );
